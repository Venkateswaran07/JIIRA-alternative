export const apiCatalog = {
  ...
  groups: {
    ...
    users: ["GET /users", "GET /users/:id", "PATCH /users/:id", "POST /users/:id/deactivate", "POST /users/:id/reactivate", "DELETE /users/:id", "POST /invitations", "POST /invitations/:id/resend", "DELETE /invitations/:id"],
