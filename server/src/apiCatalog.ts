export const apiCatalog = {
  ...
  groups: {
    ...
    operations: ["GET /notifications", "PATCH /notifications/:id/read", "POST /notifications/read-all", "GET /audit-logs", "GET /integrations/:kind", "POST /integrations/:kind", "DELETE /integrations/:kind/:id", "PATCH /organization", "GET /organization/usage", "GET /export", "POST /import/resources", "GET /reports", "GET /dashboard"],
    intelligence: ["POST /analysis/sprint-risk", "GET /analysis/examples", "GET /ai/models", "POST /ai/generate-tickets", "POST /ai/confirm-ticket-plan"],
  },
};
